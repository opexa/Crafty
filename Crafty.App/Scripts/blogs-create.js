$(document).ready(function () {
  ...
  function appendImageUpload() {
    ...
    let uploadPort = $('<input type="file" id="Images" name="Images" class="content-image-input" accept="image/*" data-id="' + lastInsertedImage + '">');
  ...
  function submitForm() {
    ...
    else
    {
      ...
      $('.form-wrapper #RelatedItems').val(getRelatedItems());
